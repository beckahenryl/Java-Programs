// InvalidConsoleData.java
// ----------------------------------------------------------------------
// Program: Invalid Console Data
// Programmer: Rebeka Henry
// Date: December 4, 2018
// ----------------------------------------------------------------------
// The class InvalidConsoleData takes input from the user and validates
...
// is displaed. And if the user inputs a number that is not within
...
public class InvalidConsoleData
{
		...
		boolean valid = true;
			...
			do
			{
				...
				if (valid)
				{
					...
					{
						System.out.println("Number must be from " 
							+ min + " to " + max + ".\n");
						valid = false;
					}
				}
